...
| `ivaoApiKey` | [developers.ivao.aero](https://developers.ivao.aero) - log in → go to your application → click **Edit** or **Create** → **Generate / Reset API Key**. Docs: [api.ivao.aero/docs](https://api.ivao.aero/docs) |
