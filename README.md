...
| `ivaoApiKey` | [developers.ivao.aero](https://developers.ivao.aero) - log in → dashboard → click **Reset API Key** to generate. Docs: [api.ivao.aero/docs](https://api.ivao.aero/docs) |
